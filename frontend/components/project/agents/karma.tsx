        ...
        {activeTab === "score" && (
          <div className="space-y-4">
            <div className="text-center">
              ...
              <div className="text-stone-400">Karma Points</div>
              <div
            ...
            <div className="grid grid-cols-2 gap-4">
              {Object.entries(mockData.impact).map(([key, value]) => (
                <div
                  key={key}
                  className="bg-stone-800/50 rounded-lg p-3 text-center"
                >
          ...
          <div className="space-y-4">
            ...
            {mockData.contributions.map((contrib, index) => (
              <div key={index} className="bg-stone-800/50 rounded-lg p-3">
                ...
                <div className="text-sm text-stone-400">{contrib.activity}</div>
              </div>
            ))}
            ...
            <div className="bg-stone-800/50 rounded-lg p-4">
              ...
              <div className="flex justify-between text-sm mb-2">
                <span className="text-stone-400">Progress to next rank</span>
