    ...
    const d = () => {
      ...
      for (let y = -h; y < h; y++) {
        for (let i = -g; i < g; i++) {
          ...
          l.addColorStop(0, "rgba(120,120,120,.1)") // Monochrome gray
          l.addColorStop(1, "rgba(80,80,80,.1)") // Darker gray
          x.fillStyle = l
          x.fill()
          x.strokeStyle = "rgba(140,140,140,.05)" // Very subtle stroke
          x.stroke()
          ...
          x.lineTo(p + s / 2, q - s / 2 - f)
          x.strokeStyle = "rgba(160,160,160,.03)" // Even more subtle
          x.stroke()
        }
      }
    }
