...
// Additional utility types for agent communication
...
export interface TaskCompletion extends AgentMessage {
...
export interface ComplianceAlert extends AgentMessage {
