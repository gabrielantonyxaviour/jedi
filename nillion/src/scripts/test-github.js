...
async function testGithub() {
    ...
    try {
        ...
        const projectId1 = await githubService.createProject("AI Chat Assistant", "An intelligent chat assistant built with TypeScript and React", "Uses OpenAI GPT-4, implements RAG with vector database, TypeScript backend with Express", "https://github.com/user/ai-chat-assistant", "john_doe", ["jane_smith", "bob_wilson"], {
            language: "TypeScript",
            framework: "React",
            stars: 234,
        ...
        const projectId2 = await githubService.createProject("Blockchain Voting System", "Decentralized voting platform on Ethereum", "Smart contracts in Solidity, Web3 frontend, IPFS for metadata storage", "https://github.com/user/blockchain-voting", "alice_crypto", ["charlie_dev"], {
            language: "Solidity",
            framework: "Hardhat",
            stars: 89,
        ...
        const janeProjects = await githubService.getProjectsByCollaborator("jane_smith");
