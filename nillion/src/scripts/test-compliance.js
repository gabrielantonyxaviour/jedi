...
async function testCompliance() {
    ...
    try {
        ...
        const recordId1 = await complianceService.createComplianceRecord("GDPR Data Processing Audit", {
            regulation: "GDPR",
            region: "EU",
            status: "compliant",
        ...
        const recordId2 = await complianceService.createComplianceRecord("SOX Financial Controls Review", {
            regulation: "SOX",
            region: "US",
            status: "under_review",
        ...
        const recordId3 = await complianceService.createComplianceRecord("HIPAA Healthcare Data Security", {
            regulation: "HIPAA",
            region: "US",
            status: "compliant",
        ...
        console.log(`✅ Created compliance records: ${recordId1}, ${recordId2}, ${recordId3}\n`);
