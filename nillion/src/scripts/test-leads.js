...
async function testLeads() {
    ...
    try {
        ...
        const leadId1 = await leadsService.createLead("TechCorp Solutions", "twitter", "Enterprise software company interested in AI automation tools", {
        ...
        const leadId2 = await leadsService.createLead("StartupX", "linkedin", "Early-stage fintech startup looking for blockchain integration", {
        ...
        const leadId3 = await leadsService.createLead("HealthTech Innovations", "conference", "Healthcare technology company seeking HIPAA-compliant solutions", {
