...
async function testServer() {
    ...
    try {
        ...
        const projectResponse = await axios.get(`${BASE_URL}/api/project/gabrielantonyxaviour/franky-agent-router`);
        console.log("✅ Project data retrieved");
        console.log("📊 Project name:", projectResponse.data.analysis.metadata.name);
        console.log("\n🎉 All tests passed!");
