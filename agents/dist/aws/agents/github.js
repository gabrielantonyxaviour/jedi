...
class GitHubIntelligenceAgent {
    ...
    async fetchRecentCommits(owner, repo, count = 10) {
    ...
    async fetchImportantFiles(owner, repo) {
    ...
    generateBasicSummary(repoInfo, commits, files) {
        // Basic rule-based summary (will replace with Bedrock later)
        const recentActivity = commits.length > 0
...
Recent Activity: ${recentActivity}
    ...
    async storeRepoData(owner, repo, summary) {
    ...
    async storeDetailedData(owner, repo, data) {
